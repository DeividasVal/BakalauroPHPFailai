...
$sql = "SELECT k.profilio_val, kp.pilnas_korepetitoriaus_vardas, k.profilio_adresas, k.profilio_dalykai, kp.korepetitoriaus_id, kp.korepetitoriaus_nuotrauka, k.profilio_id
        FROM uzklausos u 
