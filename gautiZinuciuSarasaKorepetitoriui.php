...
$sql = "SELECT zinutes.zinutes_id, zinutes.gavejo_id, zinutes.siuntejo_id, zinutes.tekstas_zinutes, zinutes.laikas_zinutes, mokinys.pilnas_mokinio_vardas, mokinys.mokinio_nuotrauka 
FROM zinutes 
LEFT JOIN mokinys ON mokinys.mokinio_id = zinutes.gavejo_id OR mokinys.mokinio_id = zinutes.siuntejo_id
